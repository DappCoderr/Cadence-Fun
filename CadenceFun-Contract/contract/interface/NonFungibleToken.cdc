...
// transaction(primarySaleID: UInt64, quantity: UInt64, priceType: String, expiration: UInt64, signature: String) {
//   let paymentVault: @FungibleToken.Vault
//   let purchaserAddress: Address
//   let purchaserCollectionRef: &{NonFungibleToken.Receiver}
//   prepare(acct: AuthAccount) {
//       let totalPrice = UFix64(quantity) * (FlowversePrimarySale.getPrice(primarySaleID: primarySaleID, type: priceType))
//       // Access the vault of the buyer to pay the sale price of the listing.
//       let mainFlowVault = acct.borrow<&FlowToken.Vault>(from: /storage/flowTokenVault)
//           ?? panic("Cannot borrow FlowToken vault from acct storage")
//       self.paymentVault <- mainFlowVault.withdraw(amount: totalPrice)
...
//       }
//       self.purchaserCollectionRef = acct.getCapability(FlowversePass.CollectionPublicPath).borrow<&{NonFungibleToken.Receiver}>()
//         ?? panic("Cannot borrow a reference to the recipient's NFT collection")
//   }
//   execute {
//     let data = FlowversePrimarySale.PurchaseDataRandom(
//         primarySaleID: primarySaleID,
//         purchaserAddress: self.purchaserAddress,
//         purchaserCollectionRef: self.purchaserCollectionRef,
//         quantity: quantity,
//         priceType: priceType,
//     )
//     let adminSignedPayload = FlowversePrimarySale.AdminSignedPayload(
//         primarySaleID: primarySaleID,
//         purchaserAddress: self.purchaserAddress,
//         expiration: expiration
//     )
//     FlowversePrimarySale.purchaseRandomNFTs(
